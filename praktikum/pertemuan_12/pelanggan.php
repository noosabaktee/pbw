   ...
   <div class="container mt-4">
       ...
       <form method="get" class="row g-3 mb-4">
           <div class="col-md-5">
               ...
               <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan nama" value="<?php htmlspecialchars($search_nama) ?>">
           </div>
           <div class="col-md-3">
               <label for="alamat" class="form-label">Cari Berdasarkan Alamat</label>
               <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Masukkan alamat" value="<?php htmlspecialchars($search_alamat) ?>">
           </div>
